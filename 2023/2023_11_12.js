/* <1> https://www.codewars.com/kata/5b2f6ad842b27ea689000082/train/javascript
...
function isSmooth(n) {
  ...
  let highestFactor = Math.max(...factors);

  if (highestFactor === 2) {
    return "power of 2";
  } else if (highestFactor === 3) {
    return "'3-smooth";
  } else if (highestFactor === 5) {
    return "Hamming number";
  } else if (highestFactor === 7) {
