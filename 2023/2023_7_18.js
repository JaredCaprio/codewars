/* <1> https://www.codewars.com/kata/644b17b56ed5527b09057987/train/javascript
Many programming languages provide the functionality of converting a string to uppercase or 
lowercase. For example, upcase/downcase in Ruby, upper/lower in Python, and toUpperCase/toLowerCase 
in Java/JavaScript. Typically, these methods won't change the size of the string.
...
/*</2> https://www.codewars.com/kata/575fa9afee048b293e000287/train/javascript
My washing machine uses water amount of water to wash load (in JavaScript and Python) or max_load 
(in Ruby) amount of clothes. You are given a clothes amount of clothes to wash. For each single 
item of clothes above the load, the washing machine will use 10% more water (multiplicative) to clean.
...
Write a function howMuchWater (JS)/how_much_water (Python and Ruby) to work out how much water
 ...
 water, load (or max_loadin Ruby) and clothes.
...
'Too much clothes'. The washing machine also cannot handle any amount of clothes less than 
