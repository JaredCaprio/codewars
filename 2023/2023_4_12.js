/* <1> https://www.codewars.com/kata/586560a639c5ab3a260000f3/train/javascript
...
You're father is far too busy with the business to worry about such details, so, naturally, he's making you come up 
with the text strings.
...
*/
function rotate(str) {
  let arrayOfShiftedWords = [];
  for (let i = 1; i < str.length + 1; i++) {
    arrayOfShiftedWords.push(str.slice(i) + str.slice(0, i));
  }
  return arrayOfShiftedWords;
}
