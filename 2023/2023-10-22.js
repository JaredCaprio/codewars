/* <1> https://www.codewars.com/kata/58989a079c70093f3e00008d/train/javascript
...
Note that the required data structure to contain the coordinates might not be the same betw
*/
function cartesianNeighbor(x, y) {
  ...
  const results = neighbors.map(([dx, dy]) => [x + dx, y + dy]);
  return results;
}
//</1>
