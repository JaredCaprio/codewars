/* <1> https://www.codewars.com/kata/56b97b776ffcea598a0006f2/train/javascript
Overview
Bubblesort is an inefficient sorting algorithm that is simple to understand and 
therefore often taught in introductory computer science courses as an example how 
not to sort a list. Nevertheless, it is correct in the sense that it eventually 
 ...
 */
function bubblesortOnce(oldArr) {
  let a = Array.from(oldArr);
  for (let i = 0; i < 1; i++) {
