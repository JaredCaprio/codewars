/* <1> https://www.codewars.com/kata/5716955a794d3013d00013f9/train/javascript
...
function theVar(theVariables) {
  let split = theVariables.split("");

  let varA = parseInt(split[0].charCodeAt(0) - 96);
  let varB = parseInt(split[2].charCodeAt(0) - 96);
