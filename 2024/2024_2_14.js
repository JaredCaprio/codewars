/* <1> https://www.codewars.com/kata/5b097da6c3323ac067000036/train/javascript
...
function solve(a, b) {
  ...
  if (scoreA === scoreB) {
    return `${scoreA}, ${scoreB}: that looks like a "draw"! Rock on!`;
  } else if (scoreB > scoreA) {
    return `${scoreA}, ${scoreB}: Bob made "Jeff" proud!`;
  } else {
    return `${scoreA}, ${scoreB}: Alice made "Kurt" proud!`;
  }
}
